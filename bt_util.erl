...
bt_client_token(Context) ->
    OsCmd = io_lib:format("python user/modules/mod_bt/priv/braintree/bt_client_token.py ~s ~s ~s ~s ~s", [
                                                             m_config:get_value('inno', 'bt_environment', Context)
                                                            ,m_config:get_value('inno', 'bt_merchant_id', Context)
                                                            ,m_config:get_value('inno', 'bt_public_key', Context)
                                                            ,m_config:get_value('inno', 'bt_private_key', Context)
